...
public class DBUtilities {
    private static Connection connection; // connect with a databse
    private static Statement statement; // execute query
    private static ResultSet resultSet; // store response/resultSet data

    /**
     * this method performs connection with a database
     * Credentials already pre-set
     * Throws exception in connection failed
     */
    public static void createConnection() {
        //this connection credentials can be changed, Vasya's ip address
     ...
     * This method does the same job as the above one
     * Connection info is required! Usually it is stored in properties file configuration.properties
     * @param DB_URL jdbc:type://hoset:port/database
     ...
     *         where every map is particular row, key  is column name, and value is row
     */
    ...
    private static void executeQuery(String query) {
        ...
        try {
            ...
            // TODO Auto-generated catch block
            e.printStackTrace();
            // for the debugging purpose we need these
    ...
    public static int executeUpdate(String query){
        try {
            ...
            e.printStackTrace();
            // we need to know the reason why the program fails
            // that's why we need this statement
